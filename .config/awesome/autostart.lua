...
awful.spawn.with_shell("setxkbmap -layout 'us(colemak),ar,us,' -option 'grp:alt_shift_toggle'");
awful.spawn.with_shell("feh --no-fehbg --bg-fill --randomize ~/Pictures/Wallpapers/*")
