...
local on_attach = function(client, bufnr)
    ...
    vim.keymap.set('n', 'gD', vim.lsp.buf.declaration,         { remap = false, silent=true , buffer = 0 , desc = 'LSP: Go to declaration'})
    vim.keymap.set('n', 'gd', vim.lsp.buf.definition,          { remap = false, silent=true , buffer = 0 , desc = 'LSP: Go to definition'})
    vim.keymap.set('n', 'K', vim.lsp.buf.hover,                { remap = false, silent=true , buffer = 0 , desc = 'LSP: View documentation'})
    vim.keymap.set('n', '<C-s>', vim.lsp.buf.signature_help,   { remap = false, silent=true , buffer = 0 , desc = 'LSP: Show function signature'})
    vim.keymap.set('n', '<space>rn', vim.lsp.buf.rename,       { remap = false, silent=true , buffer = 0 , desc = 'LSP: Rename symbol'})
    vim.keymap.set('n', 'gr', vim.lsp.buf.references,          { remap = false, silent=true , buffer = 0 , desc = 'LSP: Put references in quickfix list'})
    vim.keymap.set('n', '<space>e', vim.diagnostic.open_float, { remap = false, silent=true , buffer = 0 , desc = 'LSP: Show diagnostics'})
